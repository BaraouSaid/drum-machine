const Drumpads = ({ heaters, playSound }) => {
  return (
    <div className="grid items-center justify-center grid-cols-3 gap-8 m-4 h-92">
      {heaters.map(({ id, src, keyboardKey, clipName }) => {
        return (
          <div
            ...
            className="flex items-center justify-center bg-white rounded-md shadow-md cursor-pointer w-14 h-14 drum-pad"
            key={id}
            id={src}
          >
            {keyboardKey}
